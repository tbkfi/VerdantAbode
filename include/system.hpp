...
namespace SYSTEM {
	...
	namespace CHARSET {
		constexpr const char* CHAR_ROW_ALPHA_LOWER_0 = "abcdefghijklmnop";
		constexpr const char* CHAR_ROW_ALPHA_LOWER_1 = "qrstuvwxyz";
		constexpr const char* CHAR_ROW_ALPHA_UPPER_0 = "ABCDEFGHIJKLMNOP";
		constexpr const char* CHAR_ROW_ALPHA_UPPER_1 = "QRSTUVWXYZ";
		constexpr const char* CHAR_ROW_SPECIAL_0     = "0123456789_ +!#$%";
		constexpr const char* CHAR_ROW_SPECIAL_1     = "^&()[]<>= /\\";
		constexpr const char* CHAR_ROW_CONTROL       = "<%N+ SPECIAL CHARACTERS";
