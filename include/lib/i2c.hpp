...
public:
	...
	int read(uint8_t, uint8_t*, size_t, bool);
	int write();
...
// TODO: think again before making the same interface as pico-sdk
int I2CController::read(uint8_t addr, uint8_t* dst, size_t len, bool nostop)
{
}
